...
abstract class BSApiExtJSDBTableStoreBeforeQuery extends Hook {
	 ...
	 * @return bool
	 */
	public static function callback( $store, $queryString, $filters, &$tables, &$fields,
		&$conditions, &$options, &$joinOptions, &$dataItems ) {
	 ...
	 * @param array &$dataItems
	 */
	public function __construct( $context, $config, $store, $queryString, $filters, &$tables,
		&$fields, &$conditions, &$options, &$joinOptions, &$dataItems ) {

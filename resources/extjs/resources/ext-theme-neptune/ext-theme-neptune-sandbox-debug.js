...
*/
Ext4.define('ExtThemeNeptune.Component', {
...
Ext4.define('ExtThemeNeptune.panel.Panel', {
    override: 'Ext4.panel.Panel',
    border: false,
    bodyBorder: false,

    initBorderProps: Ext4.emptyFn,
...
Ext4.define('ExtThemeNeptune.layout.component.Dock', {
    override: 'Ext4.layout.component.Dock',
    ...
    noBorderClassTable: [
        0,                                      // TRBL
        Ext4.baseCSSPrefix + 'noborder-l',       // 0001 = 1
        Ext4.baseCSSPrefix + 'noborder-b',       // 0010 = 2
        Ext4.baseCSSPrefix + 'noborder-bl',      // 0011 = 3
        Ext4.baseCSSPrefix + 'noborder-r',       // 0100 = 4
        Ext4.baseCSSPrefix + 'noborder-rl',      // 0101 = 5
        Ext4.baseCSSPrefix + 'noborder-rb',      // 0110 = 6
        Ext4.baseCSSPrefix + 'noborder-rbl',     // 0111 = 7
        Ext4.baseCSSPrefix + 'noborder-t',       // 1000 = 8
        Ext4.baseCSSPrefix + 'noborder-tl',      // 1001 = 9
        Ext4.baseCSSPrefix + 'noborder-tb',      // 1010 = 10
        Ext4.baseCSSPrefix + 'noborder-tbl',     // 1011 = 11
        Ext4.baseCSSPrefix + 'noborder-tr',      // 1100 = 12
        Ext4.baseCSSPrefix + 'noborder-trl',     // 1101 = 13
        Ext4.baseCSSPrefix + 'noborder-trb',     // 1110 = 14
        Ext4.baseCSSPrefix + 'noborder-trbl'     // 1111 = 15
    ],
...
Ext4.define('ExtThemeNeptune.toolbar.Toolbar', {
    override: 'Ext4.toolbar.Toolbar',
    usePlainButtons: false,
    border: false
});

Ext4.define('ExtThemeNeptune.container.ButtonGroup', {
    override: 'Ext4.container.ButtonGroup',
    usePlainButtons: false
});

Ext4.define('ExtThemeNeptune.toolbar.Paging', {
    override: 'Ext4.toolbar.Paging',
    defaultButtonUI: 'plain-toolbar',
    
    inputItemWidth: 40
});

Ext4.define('ExtThemeNeptune.picker.Month', {
...
Ext4.define('ExtThemeNeptune.form.field.HtmlEditor', {
    override: 'Ext4.form.field.HtmlEditor',
    defaultButtonUI: 'plain-toolbar'
});

Ext4.define('ExtThemeNeptune.panel.Table', {
    override: 'Ext4.panel.Table',
    bodyBorder: true
});

Ext4.define('ExtThemeNeptune.grid.RowEditor', {
    override: 'Ext4.grid.RowEditor',
    buttonUI: 'default-toolbar'
});


Ext4.define('ExtThemeNeptune.grid.column.RowNumberer', {
    override: 'Ext4.grid.column.RowNumberer',
    width: 25
});

Ext4.define('ExtThemeNeptune.resizer.Splitter', {
    override: 'Ext4.resizer.Splitter',
    size: 8
});

Ext4.define('ExtThemeNeptune.menu.Menu', {
    override: 'Ext4.menu.Menu',
    showSeparator: false
});

Ext4.define('ExtThemeNeptune.menu.Separator', {
    override: 'Ext4.menu.Separator',
    border: true
});
    

Ext4.define('ExtThemeNeptune.panel.Tool', {
    override: 'Ext4.panel.Tool',
    height: 16,
    width: 16
});

Ext4.define('ExtThemeNeptune.tab.Tab', {

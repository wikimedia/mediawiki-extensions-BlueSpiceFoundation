...
class OracleUpdater extends DatabaseUpdater {
	...
	protected function doPageRestrictionsPKUKFix() {
        ...
        //HW: Überschrieben, da fehlender Prefix...
        ...
        $meta = $this->db->query( 'SELECT column_name FROM all_cons_columns WHERE owner = \''.strtoupper($this->db->getDBname()).'\' AND constraint_name = \''.$wgDBprefix.'PAGE_RESTRICTIONS_PK\' AND rownum = 1' );
		$row = $meta->fetchRow();
        ...
        //HW: kann nciht ausgeführt werden, da indizes Überprüfung nicht geht
